...
class Config:
    ...
    # MongoDB Atlas free (M0) tier ka storage limit MB mein. Doosra plan hole .env mein change karo.
    MONGO_FREE_LIMIT_MB = int(os.environ.get("MONGO_FREE_LIMIT_MB", 512))
